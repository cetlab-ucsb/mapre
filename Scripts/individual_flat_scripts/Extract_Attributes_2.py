...
arcpy.MakeRasterLayer_management(in_raster=inRaster, out_rasterlayer="lulc_for_solar_lyr", where_clause=solar_exclusion)
...
solar_extract = ExtractByAttributes("lulc_for_solar_lyr", solar_exclusion)
outsol = os.path.join(workspace_out, "lulc_for_solar")
arcpy.CopyRaster_management(solar_extract, outsol)
