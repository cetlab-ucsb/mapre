## different run or scenario - same zones as another zone result for the same extent
import arcpy
import os
arcpy.env.overwriteOutput = True

resource = "solar"
new_attributes_gdb = r"R:\users\anagha.uppal\MapRE\MapRE_data\OUTPUTS\SAPP\human.gdb"
new_attributes_filename = "Mozambique_areas_attr"
previous_zones_gdb = r"R:\users\anagha.uppal\MapRE\MapRE_data\OUTPUTS\SAPP\baseScenario_solar.gdb"
previous_zones_file = "Mozambique_areas_attr_zones"
